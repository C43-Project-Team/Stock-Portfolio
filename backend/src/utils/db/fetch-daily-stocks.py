...
log_file = '/home/raoshreyas2004/script/daily_logs.log'
...
try:
    with open('/home/raoshreyas2004/script/stock_meta_data.json') as f:
        load_stock_meta_data = json.load(f)
    log_message("Loaded stock metadata successfully")
    ...
    def insert_data_to_market_index_daily(df):
        try:
            ...
            cur.close()
            conn.close()
            log_message("Data inserted into market_index_daily table successfully")
        except Exception as e:
            log_message(f"Error inserting data into market_index_daily table: {e}")
    ...
    def insert_data_to_stocks_daily(df):
        try:
            ...
            cur.close()
            conn.close()
            log_message("Data inserted into stocks_daily table successfully")
        except Exception as e:
            log_message(f"Error inserting data into stocks_daily table: {e}")
    ...
    if __name__ == "__main__":
        ...
        log_message("Data fetched, modified, and inserted successfully!")
